...
function start(){
  ...
  let supercreature = {
	  initialate: function(){
		...
		if(windowheight < windowwidth){horizontalscreen = true}
  ...
  let action = {
	...
	readfile: async function(file,hemfun){
  ...
  let songlistcreature = {
	  ...
	  filereadsonglist: function(filepath){
		  action.readfile(filepath,function(filetext){
			  this.currentsonglist = filetext.split(/\r?\n|\r|\n/g)
		  })
	  },
